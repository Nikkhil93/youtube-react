  ...
  return (
    <div className=' m-3 relative'>
      ...
      <div className='flex mb-4'>
        ...
        <div className=' mx-6 h-14 w-40 bg-black text-white border rounded-full flex text-center justify-center items-center text-xl'> Subscribe 
        </div>
        <div className=' absolute right-3 flex bg-gray-200 rounded-full p-3 justify-center'>
      ...
      <div style={{whiteSpace: "pre-line"}} className={ !showMore ? 'bg-gray-200 relative p-3 rounded-lg h-24 overflow-clip text-sm': 'bg-gray-200 relative p-3 rounded-lg h-max text-sm my-4'}>
        {snippet?.description}
